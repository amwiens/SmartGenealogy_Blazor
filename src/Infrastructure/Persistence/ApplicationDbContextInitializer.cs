...
using SmartGenealogy.Application.Constants.ClaimTypes;
using SmartGenealogy.Application.Constants.Permission;
using SmartGenealogy.Application.Constants.Role;
using SmartGenealogy.Application.Constants.User;
...
public class ApplicationDbContextInitializer
{
    ...
    private async Task TrySeedAsync()
    {
        ...
        var demo = new ApplicationUser { UserName = UserName.Demo, Provider = "Local", IsActive = true, TenantId = _context.Tenants.First().Id, TenantName = _context.Tenants.First().Name, DisplayName = UserName.Demo, Email = "neozhu@163.com", EmailConfirmed = true, ProfilePictureDataUrl = "https://s.gravatar.com/avatar/ea753b0b0f357a41491408307ade445e?s=80" };
