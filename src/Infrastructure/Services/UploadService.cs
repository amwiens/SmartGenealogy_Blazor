using SmartGenealogy.Application.Common.Extensions;
...
public class UploadService : IUploadService
{
    ...
    public static string NextAvailableFilename(string path)
    {
        ...
        // If path has extension then insert the number pattern just before the extension and resturn next filename
