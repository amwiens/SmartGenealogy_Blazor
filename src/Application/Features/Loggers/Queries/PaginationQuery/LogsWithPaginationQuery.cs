using SmartGenealogy.Application.Features.Loggers.Caching;
using SmartGenealogy.Application.Features.Loggers.DTOs;
using SmartGenealogy.Application.Features.Loggers.Specifications;
using SmartGenealogy.Domain.Entities.Logger;

namespace SmartGenealogy.Application.Features.Loggers.Queries.PaginationQuery;
