...
using SmartGenealogy.Domain.Common;
...
public static class QueryableExtensions
{
    ...
    /// <param name="pageNumber">The desired page number or the paginated results</param>
    /// <param name="pageSize">The number or items per page in the paginated results</param>
