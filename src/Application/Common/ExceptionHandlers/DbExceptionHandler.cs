            ...
            )
        {
            switch (sqlException.Number)
            {
                case 2627: // Unique constraint error
                    errors.Add("A Unique Constraint Has Occurred While Updating the record! Duplicate Record cannot be inserted in the System.");
                    break;
                ...
                case 547: // Constrint check violation, Conflict in the database
                    errors.Add("A Constraint Check violation Error Has Occurred While Updating the record(s)!");
                    break;

                case 2601: // Duplicated key row error // Constrint violation exception // A custom exception of yours for concurrency issues
                    errors.Add("A Duplicate Key Error Has Occurred While Updating the record(s)!");
                    break;
